...
namespace Content.Server._LostParadise.DiamondCrusher.Systems;

/// <унаследование/>
public sealed class DiamondCrusherSystem : SharedDiamondCrusherSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<DiamondCrusherComponent, GetVerbsEvent<AlternativeVerb>>(OnGetVerbs);
        SubscribeLocalEvent<DiamondCrusherComponent, PowerChangedEvent>(OnPowerChanged);
    }

    private void OnGetVerbs(Entity<DiamondCrusherComponent> ent, ref GetVerbsEvent<AlternativeVerb> args)
    {
        ...
        {
            Text = Loc.GetString("diamond-crusher-verb-start-crushing"),
            Priority = 2,
    ...
    private void OnPowerChanged(Entity<DiamondCrusherComponent> ent, ref PowerChangedEvent args)
    {
        if (!args.Powered)
            StopCrushing(ent);
    }

    public void StartCrushing(Entity<DiamondCrusherComponent, EntityStorageComponent> ent)
    {
        ...
        if (crusher.AutoLock)
            _popup.PopupEntity(Loc.GetString("diamond-crusher-autolocks-enable"), uid);
        ...
        Appearance.SetData(ent, DiamondCrusherVisuals.Crushing, true);
        Dirty(ent, ent.Comp1);
    }

    public void FinishCrushing(Entity<DiamondCrusherComponent, EntityStorageComponent> ent)
    {
    ...
    public override void Update(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<DiamondCrusherComponent, EntityStorageComponent>();
