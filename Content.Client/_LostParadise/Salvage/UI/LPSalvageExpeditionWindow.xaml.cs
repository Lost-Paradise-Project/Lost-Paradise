...
public sealed partial class LPSalvageExpeditionWindow : FancyWindow,
    IComputerWindow<EmergencyConsoleBoundUserInterfaceState>
{
    private readonly IConfigurationManager _cfgManager;
    private readonly IGameTiming _timing;
    private readonly IPrototypeManager _prototype;
    private readonly SharedLPSalvageSystem _salvage;
    ...
    public LPSalvageExpeditionWindow()
    {
        RobustXamlLoader.Load(this);
        _cfgManager = IoCManager.Resolve<IConfigurationManager>();
        _timing = IoCManager.Resolve<IGameTiming>();
        _prototype = IoCManager.Resolve<IPrototypeManager>();
        _salvage = IoCManager.Resolve<IEntityManager>().EntitySysManager.GetEntitySystem<SharedLPSalvageSystem>();
    }

    public void UpdateState(LPSalvageExpeditionConsoleState state)
    {
        ...
        for (var i = 0; i < state.Missions.Count; i++)
        {
            ...
            if (!_prototype.TryIndex<LPSalvageFactionPrototype>(mission.Faction, out var factionProto) ||
            ...
            lBox.AddChild(new Label
            {
                Text = Loc.GetString(_prototype.Index<LPSalvageBiomeMod>(biome).ID),
                FontColorOverride = StyleNano.NanoGold,
                HorizontalAlignment = HAlignment.Left,
                Margin = new Thickness(0f, 0f, 0f, 5f),
            });
    ...
    protected override void FrameUpdate(FrameEventArgs args)
    {
        ...
        else
        {
            var cooldown = _cooldown
                ? TimeSpan.FromSeconds(_cfgManager.GetCVar(AccVars.SalvageExpeditionFailedCooldown))
