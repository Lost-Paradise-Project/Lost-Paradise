...
public sealed class RCDFAPMenuBoundUserInterface : BoundUserInterface
{
    ...
    public void SendRCDFAPSystemMessage(ProtoId<RCDFAPPrototype> protoId)
    {
        // A predicted message cannot be used here as the RCDFAP UI is closed immediately
        // after this message is sent, which will stop the server from receiving it
        SendMessage(new RCDFAPSystemMessage(protoId));
    }
