...
// using Content.Client.UserInterface.Systems.Emotes; // LPP
...
public sealed class GameTopMenuBarUIController : UIController
{
    ...
    // [Dependency] private readonly EmotesUIController _emotes = default!; // LPP
