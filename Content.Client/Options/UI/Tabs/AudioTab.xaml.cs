...
using Content.Shared.Corvax.CCCVars; // LPP-TTS
...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public const float TtsMultiplier = 3f; // LPP-TTS
        ...
        public AudioTab()
        {
            ...
            TtsVolumeSlider.OnValueChanged += OnTtsVolumeSliderChanged; // LPP-TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCCVars.TTSVolume, TtsVolumeSlider.Value / 100f * TtsMultiplier); // LPP-TTS
        ...
        private void Reset()
        {
            ...
            TtsVolumeSlider.Value = _cfg.GetCVar(CCCVars.TTSVolume) * 100f / TtsMultiplier; // LPP-TTS
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsVolumeSame =
                Math.Abs(TtsVolumeSlider.Value - _cfg.GetCVar(CCCVars.TTSVolume) * 100f / TtsMultiplier) < 0.01f;
            ...
            isEverythingSame = isEverythingSame && isTtsVolumeSame; // LPP-TTS
            ...
            TtsVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TtsVolumeSlider.Value / 100)); // LPP-TTS
