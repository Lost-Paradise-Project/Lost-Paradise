ent-PortableGeneratorBase = { ent-['BaseMachine', 'SmallConstructibleMachine', 'StructureWheeled'] }

    .desc = { ent-['BaseMachine', 'SmallConstructibleMachine', 'StructureWheeled'].desc }
