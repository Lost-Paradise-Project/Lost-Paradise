altar-examine = [color=purple]Этот алтарь можно использовать для принесения псионических жертв.[/color]
altar-sacrifice-verb = Жертва
altar-failure-reason-self = Ты не можешь принести в жертву себя!
altar-failure-reason-user = У тебя нет псионических или исцеляющих сил!
