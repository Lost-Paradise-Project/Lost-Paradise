...
reagent-desc-vodka-red-bool = Потому что сердечная недостаточность и печеночная недостаточность идут рука об руку.
reagent-name-xeno-basher = Ксеноцид
reagent-desc-xeno-basher = Идеальный напиток перед походом на планету жуков.
reagent-name-irish-bool = ирландская булочка
reagent-desc-irish-bool = Как булочка в ирландском магазине.
reagent-name-budget-insuls = бюджетные льготы
reagent-desc-budget-insuls = Любимый напиток грейтайдеров.
reagent-name-watermelon-wakeup = арбузное пробуждение
reagent-desc-watermelon-wakeup = Если вы хотите проснуться, этого вполне достаточно... Тоже мило.
