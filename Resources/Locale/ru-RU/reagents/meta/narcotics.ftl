...
reagent-desc-thc-oil = Чистое масло ТГК, извлеченное из листьев растения каннабис. Гораздо сильнее, чем его естественная форма, и может использоваться для подавления хронической боли у пациентов.
...
reagent-desc-happiness = Вызывает экстатическое оцепенение и незначительные повреждения мозга. Вызывает сильное привыкание. При передозировке вызывает резкие перепады настроения.
