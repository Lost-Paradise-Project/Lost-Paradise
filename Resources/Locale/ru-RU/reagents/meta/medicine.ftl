...
reagent-name-psicodine = псикоцин
reagent-desc-psicodine = Подавляет тревогу и другие различные формы психического расстройства. Передозировка вызывает галлюцинации и незначительные повреждения от токсинов.
reagent-name-potassium-iodide = йодид калия
reagent-desc-potassium-iodide = Снижает повреждающее действие радиации на 90%. Только для профилактического применения.
reagent-name-haloperidol = галоперидол
reagent-desc-haloperidol = Убирает большинство стимулирующих и галлюциногенных препаратов. Снижает эффект наркотиков и дрожь. Вызывает сонливость.
