...
bloodstream-component-selfaware-looks-pale = [color=bisque]Вы чувствуете головокружение от потери крови.[/color]
bloodstream-component-selfaware-bleeding = [color=red]У тебя кровотечение.[/color]
bloodstream-component-selfaware-profusely-bleeding = [color=crimson]У тебя обильное кровотечение![/color]
