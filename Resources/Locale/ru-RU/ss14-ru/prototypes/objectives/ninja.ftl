...
ent-MassArrestObjective = Установите для всех значение "разыскивается"
    .desc = Используйте свои перчатки, чтобы взломать панель управления криминальными архивами и объявить в розыск всю станцию!
