...
ent-ClothingHeadHelmetHardsuitCombatMedical = Шлем FPA-86
    .desc = Громоздкий шлем тактического скафандра Tsagaan Mk.II tacsuit. Защищает владельца от пуль и взрывов ценой мобильности.
...
ent-ClothingHeadHelmetHardsuitCombatRiot = Шлем FPA-93
    .desc = Модифицированный для борьбы с беспорядками шлем модели Sulde Mk.II. Предоставляет лучшую защиту чем обычный тактический шлем ценой мобильности.
...
ent-ClothingHeadHelmetHardsuitCombatAdvanced = Шлем FPA-99
    .desc = Высококачественный шлем для скафандра Dayicin Mk.II. Лёгкая конструкция позволяет обеспечить стандартный уровень защиты без ущерба мобильности.
