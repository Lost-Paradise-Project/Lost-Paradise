...
ent-ActionMorphGeras = Полиморф в Гераса
...
ent-ActionSleep = Спать
    .desc = Лечь спать.
ent-ShadowkinActionSleep = Сон Теневиков
    .desc = Лягьте спать, чтобы восстановить свои силы.
...
ent-ActionFabricateLollipop = Выдать леденец
    .desc = Дайте леценец своему пациенту, чтобы ему было лучше!
ent-ActionFabricateGumball = Выдать жвачку
    .desc = Дайте жвачку своему пациенту, чтобы ему было лучше!
ent-ActionToggleWagging = Переключить виляние
    .desc = Вилять хвостиком так мило~
