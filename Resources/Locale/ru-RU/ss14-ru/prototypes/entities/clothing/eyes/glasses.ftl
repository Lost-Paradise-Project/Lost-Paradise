...
ent-ClothingEyesGlassesEthereal = Неземные очки
    .desc = Необычные защитные очки, разработанные во времена бесчеловечных экспериментов с участием Теневиков. Они предназначены для того, чтобы позволить их владельцу вглядываться в темноту.
