...
ent-ClothingUniformJumpsuitCargo = комбинезон грузчика
    .desc = Прочный комбинезон, выдаваемый сотрудникам отдела логистики.
...
ent-ClothingUniformJumpsuitMime = костюм мима
    .desc = ...
ent-ClothingUniformJumpsuitParamedic = комбинезон медицинского офицера
    .desc = На нём есть плюс, это хорошо, верно?
ent-ClothingUniformJumpsuitBrigmedic = комбинезон медицинского офицера
...
ent-ClothingUniformJumpsuitPrisoner = комбинезон заключённого
    .desc = Арестован.
ent-ClothingUniformJumpsuitQM = комбинезон офицера логистики
    .desc = Что Браун может сделать для вас?
ent-ClothingUniformJumpsuitQMTurtleneck = водолазка офицера логистики
    .desc = Строгая водолазка, предназначенная для суровых условий работы в области логистики.
ent-ClothingUniformJumpsuitQMFormal = торжественный костюм офицера логистики
    .desc = Вдохновлённый военными офицерами логистики прошлого, прекрасный наряд для торжественных случаев.
