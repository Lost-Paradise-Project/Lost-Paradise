...
ent-ClothingBackpackDuffelCBURNFilled = Вещмешок отряда РХБЗЗ
    .desc = Вещмешок, содержащий различное оборудование для сдерживания биологической угрозы.
ent-ClothingBackpackDuffelSyndicateOperative = Вещмешок оперативника
    .desc = Большая спортивная сумка для хранения различных вещей спецагентов.
ent-ClothingBackpackDuffelSyndicateOperativeMedic = Вещмешок оперативника-медика
    .desc = Большая спортивная сумка для хранения различных вещей спецагентов, включая и медицинские запасы.
