...
ent-ClothingHeadsetCargo = гарнитура отдела логистики
    .desc = Гарнитура, используемая сотрудниками отдела логистики.
ent-ClothingHeadsetQM = гарнитура ОЛ
    .desc = Гарнитура, используемая офицером логистики.
