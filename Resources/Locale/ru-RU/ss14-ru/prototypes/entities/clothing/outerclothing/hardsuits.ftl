...
ent-ClothingOuterHardsuitLuxury = элитный шахтёрский скафандр
    .desc = Отремонтированный шахтёрский скафандр, выполненный в цветах офицера логистики. Графеновая подкладка обеспечивает меньшую защиту, но с ней гораздо легче передвигаться.
