...
ent-LockerQuarterMaster = шкаф офицера логистики
    .desc = { ent-LockerBaseSecure.desc }
...
ent-LockerMedical = шкаф медика
    .desc = { ent-LockerBase.desc }
ent-LockerParamedic = шкаф медицинского офицера
    .desc = { ent-LockerBase.desc }
...
ent-LockerWarden = шкаф смотрителя
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerBrigmedic = шкаф медицинского офицера
    .desc = { ent-LockerBaseSecure.desc }
...
ent-LockerRepresentative = шкаф представителя Nanotrasen
    .desc = { ent-LockerBaseSecure.desc }
ent-LockerCaptainSyndicate = Шкафчик капитана
