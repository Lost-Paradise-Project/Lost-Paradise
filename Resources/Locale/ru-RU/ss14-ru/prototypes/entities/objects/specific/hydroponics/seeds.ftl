...
ent-MeatwheatSeeds = Пакет семян (мясная пшеница)
    .desc = Если вы когда-нибудь хотели довести вегетарианца до безумия, вот как это сделать.
...
ent-OrangeSeeds = Пакет семян (апельсин)
    .desc = { ent-SeedBase.desc }
ent-ExtradimensionalOrangeSeeds = Пакет семян (экстрамерное апельсиновое семя)
...
ent-SugarcaneSeeds = Пакет семян (сахарный тростник)
    .desc = { ent-SeedBase.desc }
ent-PapercaneSeeds = Пакет семян (паперкейн)
    .desc = { ent-SeedBase.desc }
...
ent-RainbowCannabisSeeds = Пакет семян (радужная конопля)
    .desc = Из этих семян вырастает радужный сорняк. Превосходный... а также вызывает сильное привыкание.
...
ent-GlasstleSeeds = Пакет семян (гласстл)
...
ent-WatermelonSeeds = Пакет семян (арбуз)
    .desc = { ent-SeedBase.desc }
ent-HolymelonSeeds = Пакет семян (священная дыня)
    .desc = { ent-SeedBase.desc }
...
ent-CottonSeeds = Пакет семян (хлопок)
    .desc = { ent-SeedBase.desc }
ent-PyrottonSeeds = Пакет семян (пиротон)
    .desc = { ent-SeedBase.desc }
ent-RealCapfruitSeeds = Пакет семян (капфрут)
    .desc = Это настоящее или подделка?
