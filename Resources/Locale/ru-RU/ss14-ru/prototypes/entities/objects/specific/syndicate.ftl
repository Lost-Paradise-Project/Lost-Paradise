...
ent-BaseUplinkRadioDebug = Радио аплинк Синдиката
    .suffix = ДЕБАГ
    .desc = { ent-BaseUplinkRadio.desc }
ent-LPPStorePresetContract = Контракты Синдиката
ent-LPPStorePresetCybersunUplinks = Товары Киберсана
ent-LPPStorePresetDonkUplinks = Товары Донк
ent-LPPStorePresetGorlexUplinks = Товары Горлекса
