...
ent-MeatwheatBushel = Сноп мясной пшеницы
    .desc = Несколько покрытых кровью стеблей пшеницы. Можно размолоть их в нечто, что сойдёт за мясо, если сильно зажмуриться.
...
ent-FoodGoldenApple = золотое яблоко
    .desc = Оно должно быть кубической формы, не так ли?
...
ent-FoodOnionRedSlice = Ломтик красного лука
    .desc = Фиолетовый, несмотря на название.
ent-FoodChiliPepper = Перец чилли
    .desc = Острый, лучше не трогать в глаза.
...
ent-FoodGlasstle = glasstle
    .desc = Хрупкое кристаллическое растение с множеством шипов.
...
ent-FoodHolymelon = святой арбуз
    .desc = Вода в этом арбузе была благословлена каким-то божеством, особенно любящим арбузы.
ent-FoodHolymelonSlice = Ломтик святого арбуза
    .desc = Сочный золотой и красный ломтик.
...
ent-FoodWorldPeas = Кластер мировых горошков
    .desc = Говорят, что он приносит мир тем, кто его съедает.
ent-PyrottonBol = Шарик пироттона
    .desc = Это, вероятно, подожжёт вас.
