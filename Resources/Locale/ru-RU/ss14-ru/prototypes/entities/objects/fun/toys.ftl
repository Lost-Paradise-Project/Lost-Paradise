...
ent-PlushieGirlyCorgi = Игрушка самки корги
    .desc = Плюшка вульпканина, которую вы можете жмакать без опасений быть укушенным ( Или трахнутым... ). Погодите, что здесь за дырка..?
