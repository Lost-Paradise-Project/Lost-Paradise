...
ent-ERTEngineerIDCard = ID карта Полевого Инженера ОБР
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTJanitorIDCard = ID карта Уборщика ОБР
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTMedicIDCard = ID карта полевого Врача ОБР
    .desc = { ent-ERTChaplainIDCard.desc }
ent-ERTSecurityIDCard = ID карта Полевого Офицера ОБР
    .desc = { ent-ERTChaplainIDCard.desc }
ent-CentcomIDCardSyndie = ID карта Офицера ЦК
    .desc = { ent-IDCardStandard.desc }
    .suffix = Фальшивый
