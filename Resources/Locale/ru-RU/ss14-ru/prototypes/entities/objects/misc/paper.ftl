...
ent-PaperWrittenPunpunNote = Записка Пун-Пуна
    .desc = Лист белой бумаги.
    .suffix = Записка Пун-Пуна
...
ent-PenCentcom = Ручка Центком
    .desc = В стремлении не отстать от "мощи" бюрократической машины Cybersun, НТ создала реплику их кибер-ручки в своём корпоративном стиле.
