...
ent-CENTPDA = Специальный КПК старшего инженера
    .desc = Похоже, что это было сделано совсем недавно пользовались. На нем написано золотыми буквами: "Специальный КПК, принадлежащий лучшему Старшему Инженеру сектора". Имеет встроенный газоанализатор.
