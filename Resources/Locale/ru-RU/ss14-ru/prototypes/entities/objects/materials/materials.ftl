...
ent-MaterialGoliathHide = Пластины из шкурки Голиафа
    .desc = Части каменной шкуры Голиафа, которые могут сделать ваш скафандр немного более устойчивым к атакам местной фауны.
    .suffix = Полный
