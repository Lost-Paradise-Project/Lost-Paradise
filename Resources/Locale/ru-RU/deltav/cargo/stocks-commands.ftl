...
cmd-changestocksprice-desc = Изменяет цену акций компании на указанную сумму.
...
cmd-addstockscompany-failure = Не удалось добавить компанию на рынок акций.
cmd-addstockscompany-invalid-station = На указанной станции не найден рынок акций
cmd-addstockscompany-no-stations = Не найдено станций с рынками акций
