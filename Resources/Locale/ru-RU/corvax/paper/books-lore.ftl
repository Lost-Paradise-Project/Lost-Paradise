...
book-zp-contents =
    ...
    Из результата деятельности станции на конец смены (результат/прибыль работы отдела логистики) станция удерживает 75%. Офицер логистики получает 3% от прибыли станции вне зависимости от участия в доставке грузов. Остальная часть распределяется в виде премии между сотрудниками станции, сформировавшими доход. Например, Атмосферный техник создал газ, грузчик отнес его в отдел логистики, оба делят доход между собой. Второй пример - Утилизаторы притащили на станцию двигатели с обломка, которые были проданы. Утилизаторы делят доход между собой.
...
book-conarex-contents =
    ...
    2891 год. Conarex начинает активное военное снабжение флотов и планетарных сил умпорцев. Из-за прекрасного логистики даже в условиях попыток блокад, умпорские планетарные силы уничтожают почти все десантные силы Ноократии.
