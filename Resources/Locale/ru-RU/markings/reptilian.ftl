...
marking-LizardFrillsNeckfull-frills_neckfull = Унатх, оборки (Полная шея)
marking-LizardFrillsNeckfull = Унатх, оборки (Полная шея)
...
marking-LizardSnoutSplotch-snout_splotch_secondary = Морда
