...
uplink-reinforcement-radio-ancestor-name = Телепортатор усиленного генетического предка
uplink-reinforcement-radio-ancestor-desc = Пригласите к вам в помощь квалифицированного специалиста по вашему выбору. В комплект входит одна сигарета syndicate.
...
uplink-syndicate-martyr-module-name = Модуль киборга-смертника
...
uplink-cane-blade-name = Лезвие трости
uplink-cane-blade-desc = Трость со скрытым лезвием, которое можно вынимать как из ножен.
...
uplink-hardsuit-carp-name = Карпоскафандр
uplink-hardsuit-carp-desc = Выглядит как обычный костюм для ловли карпа, за исключением того, что полностью герметичен и заставляет космических карпов думать, что вы один из них.
...
uplink-home-run-bat-name = Бита для хоумранов
uplink-home-run-bat-desc = Специальная бита, предварительно обмазанная кровью для тренировки Синдиката по игре в мяч. Бросайте своих врагов!
...
uplink-combat-bakery-desc = Набор скрытных выпеченных оружий. Включает меч из багета, пару метательных круассанов и микроволновую плиту синдиката для создания новых. Когда дело будет сделано, съешьте улики.
