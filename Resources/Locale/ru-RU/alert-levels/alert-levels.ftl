...
alert-level-white-announcement = Станция страдает от опасно высокого уровня глиммера, существует несколько активных псионических угроз или произошла еще одна серьезная чрезвычайная ситуация научного отдела. Выключите все пробники глиммера. Ищите псионическую изоляцию. Экстрасенсы должны сообщать о нарушении сознания.
alert-level-white-instructions = Членам экипажа рекомендуется воспользоваться псионической изоляцией. Экстрасенсы должны сообщать о разрушении разума или големизации.
...
alert-level-gamma-instructions = Гражданский персонал обязан немедленно обратиться к главам отделов для получения указаний к эвакуации. Корпорация НаноТрейзен заверяет вас - опасность скоро будет нейтрализована.
...
alert-level-epsilon-announcement = Центральное командование объявило на станции уровень угрозы "Эпсилон". Все контракты расторгнуты. Спасибо, что выбрали НаноТрейзен.
