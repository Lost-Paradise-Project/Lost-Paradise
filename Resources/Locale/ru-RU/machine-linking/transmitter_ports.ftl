...
signal-port-name-dockstatus = Статус стыковки
signal-port-description-dockstatus = Этот порт вызывается с высоким значением при стыковке и низким значением при расстыковке.
