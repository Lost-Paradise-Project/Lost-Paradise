...
execution-popup-self-initial-internal = Ты подносишь { THE($weapon) } к своему горлу.
execution-popup-self-initial-external = { $attacker } подносит { POSS-ADJ($attacker) } { $weapon } к своему горлу.
execution-popup-self-complete-internal = Ты режешь себе горло!
execution-popup-self-complete-external = { $attacker } режет себе горло!
