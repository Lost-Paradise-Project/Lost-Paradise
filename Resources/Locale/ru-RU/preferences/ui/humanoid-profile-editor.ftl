...
humanoid-profile-editor-height-label = Высота: { $height }cm
...
humanoid-profile-editor-traits-show-unusable-button = Показать неиспользуемое
...
humanoid-profile-editor-loadouts-show-unusable-button = Показать неиспользуемое
...
humanoid-profile-editor-loadouts-heirloom-tooltip = Какое бы снаряжение вы ни выбрали в качестве своей потенциальной семейной реликвии, оно будет выбрано случайным образом при появлении.
