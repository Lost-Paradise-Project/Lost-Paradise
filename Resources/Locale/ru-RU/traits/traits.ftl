...
trait-description-Foreigner =
    По той или иной причине вы не говорите на любом языке станции.
...
trait-name-SolCommon = Упрощенный землянский язык
...
trait-name-Tradeband = Землянский язык
trait-description-Tradeband =
    Происходящий от латинских и романских языков старой Земли, Супериор Терра считается официальным языком Независимого Правительства Земли и одним из самых сложных в галактики.
...
trait-description-Freespeak =
    ...
    Граждани НПЗ часто называют его Уличным.
