...
trait-description-ValyrianStandard =
    ...
    На нем говорят те, кто желает поддерживать традиции и верования древних народов, живших до колониальной эпохи.trait-name-LowPotential = Низкий Пси-потенциал
