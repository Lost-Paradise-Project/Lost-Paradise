...
public sealed class LPSalvageExpeditionConsoleState : BoundUserInterfaceState
{
    ...
    public List<LPSalvageMissionParams> Missions;

    public LPSalvageExpeditionConsoleState(TimeSpan nextOffer, bool claimed, bool cooldown, bool canFinish, ushort activeMission, List<LPSalvageMissionParams> missions)
    {
        NextOffer = nextOffer;
        Claimed = claimed;
        Cooldown = cooldown;
...
public sealed partial class LPSalvageExpeditionConsoleComponent : Component
{
    /// <summary>
...
[Serializable, NetSerializable]
public sealed class ClaimLPSalvageMessage : BoundUserInterfaceMessage
{
    public ushort Index;
}

[Serializable, NetSerializable] // Frontier
public sealed class FinishLPSalvageMessage : BoundUserInterfaceMessage;

/// <summary>
/// Added per station to store data on their available salvage missions.
/// </summary>
[RegisterComponent, AutoGenerateComponentPause]
public sealed partial class LPSalvageExpeditionDataComponent : Component
{
    /// <summary>
    ...
    [ViewVariables]
    public readonly Dictionary<ushort, LPSalvageMissionParams> Missions = new();
...
[Serializable, NetSerializable]
public sealed record LPSalvageMissionParams : IComparable<LPSalvageMissionParams>
{
    [ViewVariables]
    public ushort Index;

    [ViewVariables(VVAccess.ReadWrite)]
    public LPSalvageMissionType MissionType;
    ...
    public int CompareTo(LPSalvageMissionParams? other)
    {
        if (other == null)
            return -1;
...
/// display.
/// </summary>
public sealed record LPSalvageMission(
    int Seed,
    DifficultyRating Difficulty,
    string Dungeon,
    string Faction,
    LPSalvageMissionType Mission,
    string Biome,
    string Air,
    float Temperature,
    Color? Color,
    ...
    List<string> Modifiers)
{
    ...
    /// </summary>
    public readonly string LPDungeon = Dungeon;
    ...
    /// </summary>
    public readonly LPSalvageMissionType Mission = Mission;
...
[Serializable, NetSerializable]
public enum LPSalvageConsoleUiKey : byte
{
    Expedition,
}
